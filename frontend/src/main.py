...
# 导入拆分文件
from src.utils import write_log, clean_expired_video, VIDEO_SAVE_DIR, CAPTURE_SAVE_DIR, record_audio_merge, merge_video_audio
from src.threads import VideoRecordThread, AiMonitorThread, CameraThread
from src.widgets import WarnDialog
from src.voiceplayer import VoicePlayer


# 导入RS485温湿度采集独立线程
from src.sensor_thread import SensorReadThread
from src.mgt_rs485 import read_temp_hum, COM_NAME as SENSOR_COM

from src.sys_settings import SysSettingDialog
